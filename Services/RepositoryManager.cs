...
public class RepositoryManager
{
    ...
    public void AddHint(string text, BattleHintTypes hintType)
    {
        ...
        var nextId = hints.DataList.Any() ? hints.DataList.Max(h => int.TryParse(h.Id, out var id) ? id : 0) + 1 : 1;
    ...
    {
        for (var i = 0; i < hints.DataList.Count; i++) hints.DataList[i].Id = (i + 1).ToString();
    }
